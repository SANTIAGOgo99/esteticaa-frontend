...
import {
  LayoutDashboard, Package, Scissors,
  LogOut, Database, Activity, ChevronsLeft, ChevronsRight,
  TrendingUp // 🌟 1. Importamos un icono para analíticas
} from 'lucide-react';
...
// 🌟 2. Agregamos la ruta aquí
const navItems = [
  { to: '/admin/dashboard',  icon: LayoutDashboard, label: 'Dashboard'  },
  { to: '/admin/productos',  icon: Package,         label: 'Inventario' },
  { to: '/admin/servicios',  icon: Scissors,        label: 'Servicios'  },
  { to: '/admin/respaldos',  icon: Database,        label: 'Respaldos'  },
  { to: '/admin/analiticas', icon: TrendingUp,      label: 'Analíticas' },
  { to: '/admin/stats',      icon: Activity,        label: 'Salud BD'   },
];
