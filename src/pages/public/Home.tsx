  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#FAF6F0] font-sans text-[#3D2512]">
      ...
      <main className="flex-grow">
        ...
        {/* ── HERO ── */}
        <section id="inicio" className="relative bg-[#2E1A0E] overflow-hidden" style={{ minHeight: '560px' }}>
              ...
              <div className="flex flex-col gap-8 max-w-md mx-auto lg:mx-0 text-left">
                ...
                <div className="flex items-start gap-5 group">
                  ...
                  <div className="pt-1.5">
                    ...
                    <p className="text-[#5E412F] text-[0.95rem] font-normal leading-relaxed m-0">{settings.business_address}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-5 group">
                  ...
                  <div className="pt-1.5">
                    ...
                    <p className="text-[#5E412F] text-[0.95rem] font-normal leading-relaxed m-0">
                      {phones.map((phone) => <span key={phone} className="block">{phone}</span>)}
                    </p>
                  </div>
                </div>
